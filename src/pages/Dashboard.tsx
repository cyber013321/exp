...
import { MarketOverviewWidget } from '../components/trading/MarketOverviewWidget';
import {
  Wallet,
  ArrowUpRight,
  ArrowDownLeft,
  ...
  return (
    <div className="min-h-screen bg-[#0d1117] text-[#c9d1d9] p-4 md:p-6 space-y-6 pb-20 md:pb-6">
      ...
      <div className="grid grid-cols-1 lg:grid-cols-3 gap-6">
        {/* Market Overview */}
        <div className="lg:col-span-2 bg-[#161b22] border border-[#21262d] rounded-sm overflow-hidden flex flex-col min-h-[500px]">
